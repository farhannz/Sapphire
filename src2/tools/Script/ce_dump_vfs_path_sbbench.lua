...
g_addr.load1 = 0x1624B0 -- mostly loads gfx stuff but does calc in it?
g_addr.load2 = 0x162410 -- mostly loads gfx stuff
g_addr.load3 = 0x1626B0 -- mostly loads exd data
g_addr.load4 = 0x162540 -- from this on found it because there are next to each other
g_addr.load5 = 0x162360 -- umm, vfx?
